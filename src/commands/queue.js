...
module.exports = {
    ...
    exec: async (msg) => {
        ...
        const embed = util.embed()
            ...
            .setAuthor(`${msg.guild.name} Music Queue`, "https://raw.githubusercontent.com/brblacky/mymusic/main/assets/Pin.gif?token=ASMJNSZ22D2QKX6YXTFRFC3ABWAQW", msg.guild.iconURL({ dynamic: true }))
